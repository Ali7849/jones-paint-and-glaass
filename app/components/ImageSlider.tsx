      ...
      try {
        ...
        if (!selectedLocations || selectedLocations.length === 0) {
          ...
          const selectedIds = selectedLocations.map((loc: any) =>
            typeof loc === "object"
              ? (loc.value?.id ?? loc.id ?? loc.value)
              : loc,
          );
          setFetchedLocations(
            mapped.filter((loc) => selectedIds.includes(loc.id)),
          );
        }
      } catch (err) {
  ...
  return (
    ...
    >
      ...
      <div className=" bg-white py-10 rounded-r-3xl  white-grad">
        <div className="bleed-right gap-6 ">
          <div className=" grid grid-cols-12 items-end">
            ...
            <div className="col-span-12 lg:col-span-5  pr-6 lg:pr-0">
              ...
              <p className="text-[16px] text-gray-500 leading-relaxed mb-4 lg:pr-10 font-['Avenir']">
                {description}
              </p>
              {adddescription && (
