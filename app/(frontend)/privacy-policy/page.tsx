    ...
    <>
     ...
     <div className="privacy-policy mt-20 py-14 md:py-20 container mx-auto px-4 lg:px-6">
      ...
      <p>
        ...
        contains types of information that is collected and recorded by Jones
        Paint &amp; Glass and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in Jones Paint &amp; Glass. This policy is not
      ...
      <p>
        ...
        we ask you to provide your personal information. Most commonly, this
        information is collected to provide prospective clients with more
        information about our services, pricing, etc. This means we will contact
        you via the contact methods provided to answer your questions or provide
      ...
      <ul>
        ...
        <li>
          ...
          information relating to Jones Paint &amp; Glass, and for marketing and
      ...
      <h2>Log Files</h2>
      <p>
        Jones Paint &amp; Glass follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, Jones Paint &amp; Glass uses ‘cookies’. These
      ...
      <p>
        You may consult{" "}
        <a href="https://jonespg.com/privacy-policies/">this list</a> to find
        the Privacy Policy for each of the advertising partners of Jones Paint
        &amp; Glass.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Jones Paint &amp; Glass, which
      ...
      <p>
        Note that Jones Paint &amp; Glass has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Jones Paint &amp; Glass’s Privacy Policy does not apply to other
        ...
        <a href="https://jonespg.com/privacy-policies/">
      ...
      <p>
        Jones Paint &amp; Glass does not knowingly collect any Personal
        Identifiable Information from children under the age of 18. If you think
